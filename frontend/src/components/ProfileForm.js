  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" placeholder="Zipcode 5 Character Min 9 Character Max" value={zipcode} onChange={(e) => setZipcode(e.target.value)} minLength = {5} maxLength = {9} required />
